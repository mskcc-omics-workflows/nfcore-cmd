...
def test_modules_create_nfcore_modules(self):
    ...
    module_create.create()
    assert os.path.exists(os.path.join(self.nfcore_modules, "modules", "msk-tools", "fastqc", "main.nf"))
    assert os.path.exists(os.path.join(self.nfcore_modules, "tests", "modules", "msk-tools", "fastqc", "main.nf"))
...
def test_modules_create_nfcore_modules_subtool(self):
    ...
    module_create.create()
    assert os.path.exists(os.path.join(self.nfcore_modules, "modules", "msk-tools", "star", "index", "main.nf"))
    assert os.path.exists(os.path.join(self.nfcore_modules, "tests", "modules", "msk-tools", "star", "index", "main.nf"))
